...
export default class Enemy extends Phaser.Physics.Matter.Sprite{
    ...
    static preload(scene){
        ...
        scene.load.audio("enemyHit","assets/Audio/EnemyHit.mp3");
        scene.load.audio("enemyDeath","assets/Audio/EnemyDeath.mp3");
    }
    create(){
        this.setScale(0.3);
        this.setFixedRotation();
        this.setFrictionAir(0.9);
        this.enemyHit=this.scene.sound.add("enemyHit",{volume:0.5});
        this.enemyDeath=this.scene.sound.add("enemyDeath",{volume:0.5});
    }
    update(enmSpwn){
    ...
    getHit(damage){
        ...
        if(this.actualHealth>0) this.enemyHit.play();
